...
void display() {
    ...
    glPointSize(15.0f);     // Size of the points
    ...
    // GREEN POINT IN THE TOP-RIGHT QUADRANT
        glColor3f(0.0f, 1.0f, 0.0f);
        glVertex2f(0.5f, 0.5f);
    // CYAN POINT IN THE TOP-LEFT QUADRANT
        glColor3f(0.0f, 1.0f, 1.0f);
        glVertex2f(-0.5f, 0.5f);

    // BLUE POINT IN THE BOTTOM-LEFT QUADRANT
        glColor3f(0.0f, 0.0f, 1.0f);
        glVertex2f(-0.5f, -0.5f);
    // MAGENTA POINT IN THE BOTTOM-RIGHT QUADRANT
        glColor3f(1.0f, 0.0f, 1.0f);
        glVertex2f(0.5f, -0.5f);

    // YELLOW POINT - DEAD TOP (On the Y-axis)
        glColor3f(1.0f, 1.0f, 0.0f);
        glVertex2f(0.0f, 0.75f);
    // ORANGE POINT - DEAD BOTTOM (On the Y-axis)
        glColor3f(1.0f, 0.5f, 0.0f);
        glVertex2f(0.0f, -0.75f);

    // PURPLE POINT - DEAD LEFT (On the X-axis)
        glColor3f(0.5f, 0.0f, 0.5f);
        glVertex2f(-0.75f, 0.0f);
    // WHITE POINT - DEAD RIGHT (On the X-axis)
